...
# Allocating sub.data frame to a new variable called 'corrected_frame'
...
# This is now creating a correlation function called 'frame_correlate' for the individual tract
